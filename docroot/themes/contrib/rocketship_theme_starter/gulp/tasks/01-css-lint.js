...
// Component's Paragraphs css folder

const CssLintParagraphs = function() {
  return cssLint(config.css.components.paragraphs.src);
};

gulp.task('css:lint:paragraphs', function () {
  return CssLintParagraphs();
});
...
exports.CssLintParagraphs = CssLintParagraphs;
