...
gulp.task('css:dev', gulp.series('css:message:dev','css:theme:dev', 'css:paragraphs:dev','css:features:dev', 'css:fonts', 'css:mail', 'css:editor'));
gulp.task('css:prod', gulp.series('css:theme:prod', 'css:paragraphs:prod','css:features:prod', 'css:fonts', 'css:mail', 'css:editor'));
...
exports.cssDev = gulp.series('css:message:dev','css:theme:dev', 'css:paragraphs:dev','css:features:dev', 'css:fonts', 'css:mail', 'css:editor');
exports.cssProd = gulp.series('css:theme:prod', 'css:paragraphs:prod','css:features:prod', 'css:fonts', 'css:mail', 'css:editor');
