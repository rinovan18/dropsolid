...
let config = {
    ...
    components: {
      ...
      paragraphs: {
        src: [
          'components/01-paragraphs/**/*.scss',
          '!components/*/example-*.scss',
          '!components/01-paragraphs/*/00-example/**/*.scss',
          '!components/01-paragraphs/*/styleguide/**/*.scss',
          '!components/01-paragraphs/*/00-styleguide/**/*.scss'
        ],
      },
      features: {
        src: [
    ...
    components: {
      ...
      paragraphs: {
        src: ['components/01-paragraphs/**/*.js',
          '!components/01-paragraphs/**/00-example/**/*.js',
          '!components/01-paragraphs/**/styleguide/**/*.js',
          '!components/01-paragraphs/**/00-styleguide/**/*.js'],
      },
      features: {
  ...
  stylelintConfig: {
    ...
    "rules": {
      ...
      // -- stylelint-order plugin: properties-order
