...
- `$gap-vert` is based on the line-height, because this will make space in<br />
...
- `$gap-vert-xs` `$gap-vert-sm`: these are 2 smaller variants of this, used<br />
...
Besides those, we also have special top and bottom spaces, per breakpoint.<br />
These are used by almost all rows of content. Most notably all the paragraphs,<br />
headers, related views, …<br />
