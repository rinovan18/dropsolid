...
A contact block is provided by the Office Feature <br />
(and a Molecule component for it under `components/02-features/f006-office/02-molecules/f006-office-contact`) <br />
but you could also make a custom block type under the normal Molecules if not using Office.
