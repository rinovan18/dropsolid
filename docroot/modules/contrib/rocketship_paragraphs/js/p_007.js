...
(function ($, Drupal, window, document) {
  ...
  ///////////////////////////////////////////////////////////////////////
  // Behavior for USP: triggers
  ///////////////////////////////////////////////////////////////////////

  Drupal.behaviors.rocketshipUI_p007 = {
    attach: function (context, settings) {

      var p007 = $('.paragraph--type-p-007-child', context),
          selector = '.field--name-field-p-007-child-display-field a';

      // make cards clickable: based on button link or image link
      if (p007.length && typeof self.cardLink !== 'undefined') {
        self.cardLink(p007, selector);
      }
