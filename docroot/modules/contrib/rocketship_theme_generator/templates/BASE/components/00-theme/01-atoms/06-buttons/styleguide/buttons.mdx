...
For Blocks or Paragraphs, which have special backgrounds, you will need to make extra mixins.<br />
...
In the case of Rocketship Paragraphs, you will find that a lot of the background classes are already present,<br />
so you can easily add your button mixins (or other variant styling) per background <br />
Eg. look for `&.bg--spot-1` inside of `components/01-paragraphs/03-organisms/00-paragraphs/_paragraphs.scss`
