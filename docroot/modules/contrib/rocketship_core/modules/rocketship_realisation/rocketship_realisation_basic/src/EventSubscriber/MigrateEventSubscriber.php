...
namespace Drupal\rocketship_realisation_basic\EventSubscriber;
...
class MigrateEventSubscriber implements EventSubscriberInterface {
  ...
  public static $migrateId = 'rocketship_realisation_overview';
  ...
  public function onMigratePostRowSaveEvent(MigratePostRowSaveEvent $event) {
    ...
    if ($migration->id() === static::$migrateId) {
      ...
      switch ($uuid) {
        case 'ab3aa739-180e-4432-9a19-1ea36a916e1c':
