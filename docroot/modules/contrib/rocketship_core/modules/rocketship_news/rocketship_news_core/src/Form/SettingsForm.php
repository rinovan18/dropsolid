...
/**
 * @file
 * Contains Drupal\rocketship_news_core\Form\SettingsForm.
 */

namespace Drupal\rocketship_news_core\Form;
 ...
 * Class SettingsForm.
 *
 * @package Drupal\rocketship_news_core\Form
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'rocketship_news_core_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('rocketship_news_core.settings');
