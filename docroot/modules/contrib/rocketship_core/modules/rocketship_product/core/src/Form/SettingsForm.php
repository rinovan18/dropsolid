...
/**
 * @file
 * Contains Drupal\rocketship_product_core\Form\SettingsForm.
 */

namespace Drupal\rocketship_product_core\Form;
 ...
 * Class SettingsForm.
 *
 * @package Drupal\rocketship_product_core\Form
 */
class SettingsForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return [
        'rocketship_product_core.settings',
    ];
  }
  ...
  public function getFormId() {
    return 'rocketship_product_core_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('rocketship_product_core.settings');
