...
/**
 * Class EventConfigSettingsForm.
 *
 * @ingroup rocketship_event_core
 */
class EventConfigSettingsForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return [
        'rocketship_event_core.settings',
    ];
  }
  ...
  public function getFormId() {
    return 'rocketship_event_core_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('rocketship_event_core.settings');
